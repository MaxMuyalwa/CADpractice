  ...
  return (
    <section className="relative z-10 py-24 bg-background transition-colors duration-300">
      <div className="max-w-5xl mx-auto px-8">
        <div className="bg-background border border-neu-shadow-dark/10 rounded-[40px] p-12 shadow-[16px_16px_32px_var(--shadow-dark),-8px_-8px_16px_var(--shadow-light)] flex flex-col md:flex-row items-center gap-12 transition-all">
