        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="flex flex-col items-start text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg mb-6
              bg-[#E5E5E5] dark:bg-[#000805] border border-gray-200 dark:border-gray-800
              shadow-md
              animate-fade-in-up">
              <span className="relative flex h-2 w-2">
                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#08CB00] opacity-75" />
                <span className="relative inline-flex rounded-full h-2 w-2 bg-[#08CB00]" />
              </span>
              <span className="text-sm font-semibold text-[#08CB00]">
