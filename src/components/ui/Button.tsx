  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:ring-2 focus-visible:ring-neu-green/50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        outline:
          "bg-background text-neu-text-primary border border-neu-shadow-dark/10 shadow-[6px_6px_12px_var(--shadow-dark),-3px_-3px_6px_var(--shadow-light)] hover:shadow-[inset_4px_4px_8px_var(--shadow-dark),inset_-2px_-2px_4px_var(--shadow-light)]",
        secondary:
          "bg-background text-neu-text-secondary shadow-[4px_4px_8px_var(--shadow-dark),-2px_-2px_4px_var(--shadow-light)] hover:shadow-inner",
        ghost:
