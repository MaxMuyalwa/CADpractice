...
export const About = () => {
  return (
    <main className="pt-32 pb-20 px-6 md:px-12 relative z-10 min-h-screen text-white">
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        >
          ...
          <button className="px-10 py-4 bg-[#08CB00] text-black font-black uppercase tracking-widest rounded-md hover:bg-[#0aed00] transition-all transform hover:scale-105">
            Get Started
          </button>
        </motion.div>
      </div>
